...
![Set-Cookie (HTTP Response)](/WEB/Cookie And Session/set-cookie.png)

Set-Cookie (HTTP Response)

![Cookie (HTTP Request)](/WEB/Cookie And Session/cookie.png)
...
![세션 생성](/WEB/Cookie And Session/session-create.png)

![세션 조회](/WEB/Cookie And Session/session-read.png)
